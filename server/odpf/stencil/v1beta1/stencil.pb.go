...
var file_odpf_stencil_v1beta1_stencil_proto_depIdxs = []int32{
	...
	32, // 2: odpf.stencil.v1beta1.Namespace.created_at:type_name -> google.protobuf.Timestamp
	32, // 3: odpf.stencil.v1beta1.Namespace.updated_at:type_name -> google.protobuf.Timestamp
	...
	32, // 6: odpf.stencil.v1beta1.Schema.created_at:type_name -> google.protobuf.Timestamp
	32, // 7: odpf.stencil.v1beta1.Schema.updated_at:type_name -> google.protobuf.Timestamp
	...
	4,  // 22: odpf.stencil.v1beta1.StencilService.ListNamespaces:input_type -> odpf.stencil.v1beta1.ListNamespacesRequest
	6,  // 23: odpf.stencil.v1beta1.StencilService.GetNamespace:input_type -> odpf.stencil.v1beta1.GetNamespaceRequest
	8,  // 24: odpf.stencil.v1beta1.StencilService.CreateNamespace:input_type -> odpf.stencil.v1beta1.CreateNamespaceRequest
	10, // 25: odpf.stencil.v1beta1.StencilService.UpdateNamespace:input_type -> odpf.stencil.v1beta1.UpdateNamespaceRequest
	12, // 26: odpf.stencil.v1beta1.StencilService.DeleteNamespace:input_type -> odpf.stencil.v1beta1.DeleteNamespaceRequest
	14, // 27: odpf.stencil.v1beta1.StencilService.ListSchemas:input_type -> odpf.stencil.v1beta1.ListSchemasRequest
	18, // 28: odpf.stencil.v1beta1.StencilService.CreateSchema:input_type -> odpf.stencil.v1beta1.CreateSchemaRequest
	20, // 29: odpf.stencil.v1beta1.StencilService.GetSchemaMetadata:input_type -> odpf.stencil.v1beta1.GetSchemaMetadataRequest
	22, // 30: odpf.stencil.v1beta1.StencilService.UpdateSchemaMetadata:input_type -> odpf.stencil.v1beta1.UpdateSchemaMetadataRequest
	16, // 31: odpf.stencil.v1beta1.StencilService.GetLatestSchema:input_type -> odpf.stencil.v1beta1.GetLatestSchemaRequest
	24, // 32: odpf.stencil.v1beta1.StencilService.DeleteSchema:input_type -> odpf.stencil.v1beta1.DeleteSchemaRequest
	28, // 33: odpf.stencil.v1beta1.StencilService.GetSchema:input_type -> odpf.stencil.v1beta1.GetSchemaRequest
	26, // 34: odpf.stencil.v1beta1.StencilService.ListVersions:input_type -> odpf.stencil.v1beta1.ListVersionsRequest
	30, // 35: odpf.stencil.v1beta1.StencilService.DeleteVersion:input_type -> odpf.stencil.v1beta1.DeleteVersionRequest
	5,  // 36: odpf.stencil.v1beta1.StencilService.ListNamespaces:output_type -> odpf.stencil.v1beta1.ListNamespacesResponse
	7,  // 37: odpf.stencil.v1beta1.StencilService.GetNamespace:output_type -> odpf.stencil.v1beta1.GetNamespaceResponse
	9,  // 38: odpf.stencil.v1beta1.StencilService.CreateNamespace:output_type -> odpf.stencil.v1beta1.CreateNamespaceResponse
	11, // 39: odpf.stencil.v1beta1.StencilService.UpdateNamespace:output_type -> odpf.stencil.v1beta1.UpdateNamespaceResponse
	13, // 40: odpf.stencil.v1beta1.StencilService.DeleteNamespace:output_type -> odpf.stencil.v1beta1.DeleteNamespaceResponse
	15, // 41: odpf.stencil.v1beta1.StencilService.ListSchemas:output_type -> odpf.stencil.v1beta1.ListSchemasResponse
	19, // 42: odpf.stencil.v1beta1.StencilService.CreateSchema:output_type -> odpf.stencil.v1beta1.CreateSchemaResponse
	21, // 43: odpf.stencil.v1beta1.StencilService.GetSchemaMetadata:output_type -> odpf.stencil.v1beta1.GetSchemaMetadataResponse
	23, // 44: odpf.stencil.v1beta1.StencilService.UpdateSchemaMetadata:output_type -> odpf.stencil.v1beta1.UpdateSchemaMetadataResponse
	17, // 45: odpf.stencil.v1beta1.StencilService.GetLatestSchema:output_type -> odpf.stencil.v1beta1.GetLatestSchemaResponse
	25, // 46: odpf.stencil.v1beta1.StencilService.DeleteSchema:output_type -> odpf.stencil.v1beta1.DeleteSchemaResponse
	29, // 47: odpf.stencil.v1beta1.StencilService.GetSchema:output_type -> odpf.stencil.v1beta1.GetSchemaResponse
	27, // 48: odpf.stencil.v1beta1.StencilService.ListVersions:output_type -> odpf.stencil.v1beta1.ListVersionsResponse
	31, // 49: odpf.stencil.v1beta1.StencilService.DeleteVersion:output_type -> odpf.stencil.v1beta1.DeleteVersionResponse
