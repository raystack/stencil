            ...
            contents={[
              {
                ...
                content: (
                  <div>
                    The Stencil team has an open source slack workspace to discuss development and support.
                    Most of the Stencil discussions happen in #stencil channel.
                    <br /><a href="#"> Join us on Slack </a>
                  </div>)
              },
              {
                title: 'GitHub Issues',
                content: (
                  <div>
                    ...
                    <br /> <a target="_blank" href="https://github.com/goto/stencil/issues"> Go to issues </a>
              ...
              },
              {
                ...
                content: (
                  <div>
                    ...
                    <br /><a target="_blank" href="https://github.com/goto/stencil/discussions"> Go to discussions </a>
