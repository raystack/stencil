...
func (_m *SchemaService) List(ctx context.Context, namespaceID string) ([]string, error) {
...
// NewSchemaService creates a new instance of SchemaService. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSchemaService(t testing.TB) *SchemaService {
	mock := &SchemaService{}
	mock.Mock.Test(t)
