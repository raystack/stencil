...
// CheckCompatibility provides a mock function with given fields: _a0, _a1
func (_m *StencilServiceServer) CheckCompatibility(_a0 context.Context, _a1 *stencilv1beta1.CheckCompatibilityRequest) (*stencilv1beta1.CheckCompatibilityResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *stencilv1beta1.CheckCompatibilityResponse
	if rf, ok := ret.Get(0).(func(context.Context, *stencilv1beta1.CheckCompatibilityRequest) *stencilv1beta1.CheckCompatibilityResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *stencilv1beta1.CheckCompatibilityRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *StencilServiceServer) Search(_a0 context.Context, _a1 *stencilv1beta1.SearchRequest) (*stencilv1beta1.SearchResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *stencilv1beta1.SearchResponse
	if rf, ok := ret.Get(0).(func(context.Context, *stencilv1beta1.SearchRequest) *stencilv1beta1.SearchResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *stencilv1beta1.SearchRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
