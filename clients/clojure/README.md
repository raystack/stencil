...
option java_package = "com.gotocompany.CljTest";
...
(def serialized-data
     (serialize client "com.gotocompany.CljTest" {:name "Foo"
                                          :address {:street "bar"}
...
(deserialize client "com.gotocompany.CljTest" serialized-data)
;; prints
;; {:name "Foo"
;; :address {:street "bar"}
;; :email-list ["a@example.com" "b@b.com"]
...
- `get-descriptor (client proto-class-name)`
  ...
  (let [client (create-client sample-client-config)
        proto-package "com.gotocompany.stencil_clj_test"
