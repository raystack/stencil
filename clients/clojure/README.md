...
A Clojure library designed to easily encode and decode protobuf messages by using protobuf descriptor objects.
...
- `create-client (client-config)`
  ...
  ### Exceptions- throws an instance of ExceptionInfo, a RuntimeException subclass that carries a map of additional data
  | Name                                            | Condition When Raised                                                         |
  |-------------------------------------------------|-------------------------------------------------------------------------------|
  | **ClientInitializationFailedException**         | Sub-cause: Invalid client configuration provided                              |
  | **ClientInitializationFailedException**         | Sub-cause: When there is any other runtime exception                          |
