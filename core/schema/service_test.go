...
func TestSchemaCreate(t *testing.T) {
	...
	t.Run("should return error if previous latest schema is not valid", func(t *testing.T) {
		...
		schemaRepo.On("GetSchemaMetadata", mock.Anything, nsName, "a").Return(&schema.Metadata{Format: "protobuf"}, nil)
...
func TestGetSchema(t *testing.T) {
	...
	t.Run("should return error if get metadata fails", func(t *testing.T) {
		svc, _, _, repo := getSvc()
		repo.On("GetSchemaMetadata", mock.Anything, nsName, schemaName).Return(&schema.Metadata{}, errors.New("get metadata error"))
	...
	t.Run("should return error if getting data fails", func(t *testing.T) {
		svc, _, _, repo := getSvc()
		version := int32(1)
		repo.On("GetSchemaMetadata", mock.Anything, nsName, schemaName).Return(&schema.Metadata{}, nil)
