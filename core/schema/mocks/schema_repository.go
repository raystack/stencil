...
func (_m *SchemaRepository) List(_a0 context.Context, _a1 string) ([]string, error) {
...
// NewSchemaRepository creates a new instance of SchemaRepository. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSchemaRepository(t testing.TB) *SchemaRepository {
