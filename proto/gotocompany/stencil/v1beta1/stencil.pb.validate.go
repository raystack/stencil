...
// Validate checks the field values on SchemaChangedEvent with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SchemaChangedEvent) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SchemaChangedEvent with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SchemaChangedEventMultiError, or nil if none found.
func (m *SchemaChangedEvent) ValidateAll() error {
	return m.validate(true)
}

func (m *SchemaChangedEvent) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, SchemaChangedEventValidationError{
		...
		if err := v.Validate(); err != nil {
			return SchemaChangedEventValidationError{
				field:  "EventTimestamp",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	{
		sorted_keys := make([]string, len(m.GetUpdatedFields()))
		i := 0
		for key := range m.GetUpdatedFields() {
			sorted_keys[i] = key
			i++
		}
		sort.Slice(sorted_keys, func(i, j int) bool { return sorted_keys[i] < sorted_keys[j] })
		for _, key := range sorted_keys {
			val := m.GetUpdatedFields()[key]
			_ = val

			// no validation rules for UpdatedFields[key]
			...
			if all {
				...
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, SchemaChangedEventValidationError{
							field:  fmt.Sprintf("UpdatedFields[%v]", key),
							reason: "embedded message failed validation",
							cause:  err,
						})
					}
	...
	{
		sorted_keys := make([]string, len(m.GetImpactedSchemas()))
		i := 0
		for key := range m.GetImpactedSchemas() {
			sorted_keys[i] = key
			i++
		}
		sort.Slice(sorted_keys, func(i, j int) bool { return sorted_keys[i] < sorted_keys[j] })
		for _, key := range sorted_keys {
			val := m.GetImpactedSchemas()[key]
			_ = val

			// no validation rules for ImpactedSchemas[key]
			...
			if all {
				...
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, SchemaChangedEventValidationError{
							field:  fmt.Sprintf("ImpactedSchemas[%v]", key),
							reason: "embedded message failed validation",
							cause:  err,
						})
					}
	...
	if len(errors) > 0 {
		return SchemaChangedEventMultiError(errors)
	}

	return nil
}

// SchemaChangedEventMultiError is an error wrapping multiple validation errors
// returned by SchemaChangedEvent.ValidateAll() if the designated constraints
// aren't met.
type SchemaChangedEventMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SchemaChangedEventMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SchemaChangedEventMultiError) AllErrors() []error { return m }

// SchemaChangedEventValidationError is the validation error returned by
// SchemaChangedEvent.Validate if the designated constraints aren't met.
type SchemaChangedEventValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SchemaChangedEventValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SchemaChangedEventValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SchemaChangedEventValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SchemaChangedEventValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SchemaChangedEventValidationError) ErrorName() string {
	return "SchemaChangedEventValidationError"
}

// Error satisfies the builtin error interface
func (e SchemaChangedEventValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSchemaChangedEvent.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SchemaChangedEventValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SchemaChangedEventValidationError{}

// Validate checks the field values on ImpactedFields with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ImpactedFields) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ImpactedFields with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ImpactedFieldsMultiError,
// or nil if none found.
func (m *ImpactedFields) ValidateAll() error {
	return m.validate(true)
}

func (m *ImpactedFields) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ImpactedFieldsMultiError(errors)
	}

	return nil
}

// ImpactedFieldsMultiError is an error wrapping multiple validation errors
// returned by ImpactedFields.ValidateAll() if the designated constraints
// aren't met.
type ImpactedFieldsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ImpactedFieldsMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ImpactedFieldsMultiError) AllErrors() []error { return m }

// ImpactedFieldsValidationError is the validation error returned by
// ImpactedFields.Validate if the designated constraints aren't met.
type ImpactedFieldsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ImpactedFieldsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ImpactedFieldsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ImpactedFieldsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ImpactedFieldsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ImpactedFieldsValidationError) ErrorName() string { return "ImpactedFieldsValidationError" }

// Error satisfies the builtin error interface
func (e ImpactedFieldsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = ImpactedFieldsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ImpactedFieldsValidationError{}

// Validate checks the field values on ImpactedSchemas with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *ImpactedSchemas) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ImpactedSchemas with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ImpactedSchemasMultiError, or nil if none found.
func (m *ImpactedSchemas) ValidateAll() error {
	return m.validate(true)
}

func (m *ImpactedSchemas) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ImpactedSchemasMultiError(errors)
	}

	return nil
}

// ImpactedSchemasMultiError is an error wrapping multiple validation errors
// returned by ImpactedSchemas.ValidateAll() if the designated constraints
// aren't met.
type ImpactedSchemasMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ImpactedSchemasMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ImpactedSchemasMultiError) AllErrors() []error { return m }

// ImpactedSchemasValidationError is the validation error returned by
// ImpactedSchemas.Validate if the designated constraints aren't met.
type ImpactedSchemasValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ImpactedSchemasValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ImpactedSchemasValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ImpactedSchemasValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ImpactedSchemasValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ImpactedSchemasValidationError) ErrorName() string { return "ImpactedSchemasValidationError" }

// Error satisfies the builtin error interface
func (e ImpactedSchemasValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sImpactedSchemas.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ImpactedSchemasValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ImpactedSchemasValidationError{}
